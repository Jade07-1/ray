...
# V2-fast: fast upscaling for homogeneous large-batch workloads.
AUTOSCALER_FAST_UPSCALING_ENABLED = env_integer("RAY_AUTOSCALER_FAST_UPSCALING", 0)
AUTOSCALER_FAST_UPSCALING_THRESHOLD = env_integer(
    "RAY_AUTOSCALER_FAST_UPSCALING_THRESHOLD", 100
)
AUTOSCALER_FAST_UPSCALING_DOMINANCE_RATIO = float(
    os.environ.get("RAY_AUTOSCALER_FAST_UPSCALING_DOMINANCE_RATIO", "0.95")
)
AUTOSCALER_FAST_UPSCALING_DEGRADATION_RATE = float(
    os.environ.get("RAY_AUTOSCALER_FAST_UPSCALING_DEGRADATION_RATE", "0.3")
)
